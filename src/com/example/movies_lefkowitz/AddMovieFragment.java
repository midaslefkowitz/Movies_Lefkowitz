...
public class AddMovieFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		.setTitle("Add Movie")
		.setMessage("Would you like to add movie manually or from the internet?")
		.setPositiveButton("Internet", new OnClickListener() {
			...
			public void onClick(DialogInterface arg0, int arg1) {
				...
				startActivityForResult(searchActivityIntent, MainFragment.REQUEST_SEARCH);
			}
		})
		.setNegativeButton("Manual", new OnClickListener() {
			...
			public void onClick(DialogInterface arg0, int arg1) {
				...
				startActivityForResult(editActivityIntent, MainFragment.REQUEST_MANUAL);
			}
		})
