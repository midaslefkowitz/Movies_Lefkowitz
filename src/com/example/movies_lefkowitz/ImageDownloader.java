...
public class ImageDownloader {
    ...
    public void download(String url, Activity activity, ImageView imageView, int targetHeight) {
        ...
        if (bitmap == null) {
        	Log.d(LOG_TAG, "Downloading " + picFileName + " from internet");
            forceDownload(url, activity, imageView, targetHeight);
        } else {
            cancelPotentialDownload(url, imageView);
            Log.d(LOG_TAG, "Loaded " + picFileName + " image from cache");
    ...
    class BitmapDownloaderTask extends AsyncTask<String, Void, Bitmap> {
        ...
        */
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            Log.d(LOG_TAG, "Added " + picFileName + " to the cache");
        ...
        private Bitmap scaleImage(Bitmap drawing) {
    	    if (drawing == null) {
    	        return null; // Checking for null & return
    	    }
    	    // Get current dimensions and its ratio
    	    int width = drawing.getWidth();
    	    int height = drawing.getHeight();
    	    
    	    // Get Bounding Height in px
    	    int ivHeight = dpToPx(targetHeight);
    	    
    	    // Get ratio of image dimensions to desired dimensions
    	    float hRatio = (float)ivHeight/(float)height;
            ...
            Bitmap scaledBitmap = Bitmap.createBitmap(drawing, 0, 0, width, height, matrix, true);
    ...
    private void addBitmapToCache(String url, Bitmap bitmap) {
        if (bitmap != null) {
        	String picFileName = url.substring(url.lastIndexOf('/')+1);
        	Log.d(LOG_TAG, "Added " + picFileName + " pic to cache");
    ...
    private Bitmap getBitmapFromCache(String url) {
        ...
        synchronized (sHardBitmapCache) {
            ...
            if (bitmap != null) {
            	Log.d(LOG_TAG, "Loaded image from hardcache");
        ...
        if (bitmapReference != null) {
            ...
            Log.d(LOG_TAG, "Loaded image from softcache");
            if (bitmap != null) {
