...
package com.example.movies_lefkowitz.helper_classes;
    ...
    class BitmapDownloaderTask extends AsyncTask<String, Void, Bitmap> {
        ...
        */
        ...
        private Bitmap scaleImage(Bitmap drawing) {
            ...
            // Create and return new bitmap and convert it to a format understood by the ImageView 
            return Bitmap.createBitmap(drawing, 0, 0, width, height, matrix, true);
    	}
